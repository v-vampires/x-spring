...
import com.x.spring.framework.annotation.Controller;
import com.x.spring.framework.annotation.RequestMapping;
import com.x.spring.framework.context.support.DefaultApplicationContext;
...
public class DispatcherServlet extends HttpServlet {
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        if (handler == null) {
            //没有找到handler返回404
            processDispatchResult(req, resp, "404 not found HandlerMapping！");
            return;
        }
        //2、准备调用前的参数
        ...
        String result = ha.handle(req, resp, handler);

        //4、渲染页面输出
        processDispatchResult(req, resp, result);
    }

    private void processDispatchResult(HttpServletRequest req, HttpServletResponse resp, String result) throws IOException {
